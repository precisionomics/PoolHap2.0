...
public class ComparisonSim_island_arc_new2 {
	...
	public ComparisonSim_island_arc_new2(String prefix_folder, String slimout_folder,int num_pool) throws IOException {
		int[] project_idx1= {num_pool};
		new File(prefix_folder + "/cmd/").mkdir();
		for (int i =0; i< project_idx1.length; i++) {
			for (int j =1; j< 22; j++) {
				
				String project_name = project_idx1[i]+"_"+ j;
...
//	Step 5. Convert each pool-specific BAM file to SAM (i.e.: text), then VEF files.	
	...
	public static  void main(String[] args) throws IOException, InterruptedException {
		...
		int num_pool =  Integer.parseInt(args[2]);
		ComparisonSim_island_arc_new2 cs = new ComparisonSim_island_arc_new2(prefix_folder,slimout_folder,num_pool);
