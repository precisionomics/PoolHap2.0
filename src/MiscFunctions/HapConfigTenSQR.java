...
// NOTE: This HapConfig class specifically address changes need to be made for compatibility with
// TenSQR
public class HapConfigTenSQR {
     ...
     * 		(1.3) The first column is the IDs of all loci.// this.update_sigma_mu_logL();
     ...
     */
    public HapConfigTenSQR(String[][] global_haps_string, double[] global_haps_freq, double[][] in_pool_haps_freq, double[][] inpool_site_freqs, LocusAnnotation[] locusInput, int num_pools, String[] hap_IDs, String[] pool_IDs, int est_ind_pool){
    ...
    public HapConfigTenSQR(HapConfigTenSQR[] final_local_haps){
     ...
     */
    public HapConfigTenSQR(String global_hap_input_file, String in_pool_hap_input_file){
        try{
     ...
     */
    public HapConfigTenSQR clone(double freq_cutoff){
        if (freq_cutoff == 0) return new HapConfigTenSQR(this.global_haps_string, this.global_haps_freq, this.in_pool_haps_freq, this.inpool_site_freqs, this.locusInfo, this.num_pools, this.hap_IDs, this.pool_IDs, this.est_ind_pool);
        ...
        // for (int h = 0; h < this.num_global_hap; h++)
            // System.out.println(this.hap_IDs[h]);
        return new HapConfigTenSQR(this.global_haps_string, this.global_haps_freq, this.in_pool_haps_freq, this.inpool_site_freqs, this.locusInfo, this.num_pools, this.hap_IDs, this.pool_IDs, this.est_ind_pool);
    }
