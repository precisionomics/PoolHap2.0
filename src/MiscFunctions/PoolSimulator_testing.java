...
public class PoolSimulator_testing {
	...
	public PoolSimulator_testing(String parameter_file) throws IOException {
 ...
 //       this.inter_dir = prop.getProperty("Intermediate_Dir");
	 ...
	 * @throws IOException
	 */
	public void processing_ms_outcome() throws IOException, InterruptedException{
	    //int[] sim_var_pos = new int[num_var_pos];
        ...
        System.out.println("check-1 hap2varcomp[]");
        for(int i=0;i<hap2varcomp.length;i++) {
        	System.out.println(hap2varcomp[i]);
        }
        System.out.println();
        int hap = 0; 
        ...
        System.out.println("check-1 hap2cts[]");
        for(int i=0;i<hap2cts.length;i++) {
        	System.out.println(hap2cts[i]);
        }
        System.out.println();
        System.out.println("check-2 hap2varcomp[]");
        for(int i=0;i<hap2varcomp.length;i++) {
        	System.out.println(hap2varcomp[i]);
        }
        System.out.println();
	...
	public void ms_reports() throws IOException {
        ...
        System.out.println("check-1 hap2allfreqs[]");
        for(int i=0;i<hap2allfreqs.length;i++) {
        	System.out.println(hap2allfreqs[i]);
        }
        System.out.println();
        ...
        System.out.println("check-2 hap2cts[]");
        for(int i=0;i<hap2cts.length;i++) {
        	System.out.println(hap2cts[i]);
        }
        System.out.println();
        
        System.out.println("check-2 hap2allfreqs[]");
        for(int i=0;i<hap2allfreqs.length;i++) {
        	System.out.println(hap2allfreqs[i]);
        }
        System.out.println();
	...
	public void assign_haps_to_pools() throws IOException {    
        ...
        System.out.println("check-1 hap2infreqs[]");
        for(int i=0;i<hap2infreqs.length;i++) {
        	System.out.println(hap2infreqs[i]);
        }
        System.out.println();
        
        System.out.println("check-3 hap2cts[]");
        for(int i=0;i<hap2cts.length;i++) {
        	System.out.println(hap2cts[i]);
        }
        System.out.println();
        ...
        System.out.println("check-3 hap2allfreqs[]");
        for(int i=0;i<hap2allfreqs.length;i++) {
        	System.out.println(hap2allfreqs[i]);
        }
        System.out.println();
        
        System.out.println("check-2 hap2infreqs[]");
        for(int i=0;i<hap2infreqs.length;i++) {
        	System.out.println(hap2infreqs[i]);
        }
        System.out.println();
...
//        br.close();
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		PoolSimulator_testing ps=new PoolSimulator_testing(parameter);
