...
public class PoolSimulator_testing {
 ...
 //       this.inter_dir = prop.getProperty("Intermediate_Dir");
	...
	public void processing_ms_outcome() throws IOException{
        ...
        System.out.println(gs_dir + project_name + ".ms.txt");
        ...
        System.out.println(tmpVarPos[1]); //ok 
        System.out.println(num_var_pos);
        System.out.println(ref_seq_len);
        System.out.println(tmpVarPos[num_var_pos]);//ok
        ...
        for (int p = 1; p < num_var_pos + 1; p++) {
            ...
            System.out.println(sim_var_pos[p-1]);
        ...
        for (String h : hapsHS.keySet()) {
            ...
            System.out.println("Check 2");
            System.out.println(var_burden_ct);
        ...
        System.out.println(var_burden_avg);
	}
