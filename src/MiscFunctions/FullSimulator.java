...
public class FullSimulator {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < 5; i++) currLine = br2.readLine();
		...
		int ptHaps = Integer.parseInt(args[6]); 	// Between 3 and 15 individual viruses in each patient.
