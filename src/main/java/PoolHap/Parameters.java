...
public class Parameters {
    ...
    public static class DivideParameters extends Parameters {
        ...
        // Because of trimming, we may not be able to form all full haplotypes. Cutoff to halt that.
        // public int max_num_rounds_forming_initial_haps;

        // The max number of haps that will be allowed in the AEM algorithm.
        // (When there are too many haps from GC, this parameter will be used to filter low-support
        // haps out.)
        ...
        public DivideParameters(String propFilePath) throws IOException {
            ...
            try {
                ...
                // this.max_num_rounds_forming_initial_haps =
                //         Integer.parseInt(prop.getProperty("Rounds_Haps4Regions_Max"));
                // this.max_num_haps = Integer.parseInt(prop.getProperty("Haps_Per_Region_Max"));
                // this.est_ind_pool = Integer.parseInt(prop.getProperty("Est_Ind_PerPool"));
                // this.level_I_and_II_alignment_cutoff =
                //         Integer.parseInt(prop.getProperty("Region_Alignment_Cutoff"));
