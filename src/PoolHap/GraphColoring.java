...
//        		System.out.println(read_pos_2D_arr.get(i).get(j).toString());
        ...
        // System.out.println("Finished making all potential haplotypes. Now printing results.");
        // fileOut("tmp2.txt");
    }
...
//        }
	...
	public HapConfig hapOut() {
    	...
    	System.out.println("There are " + num_global_hap + " haplotypes generated by the second round of GC.");
    	java.util.Arrays.fill(global_haps_freq, 1.0 / num_global_hap);
