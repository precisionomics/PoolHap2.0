...
public class ScriptForTool_arc_new {
	...
	public ScriptForTool_arc_new(String prefix_folder, String phx_folder_prefix, String tool_name) throws IOException {
...
//				#SBATCH --exclude=node[029-033]
				bw.write("#!/bin/bash\n");
				bw.write("#SBATCH --job-name=50_1"+ tool_name + project_name+"\n");
				...
				for (int p=0;p < this.num_pool/2;p ++) {
					String pool_name = project_name +"_p"+p;
					String pool_folder = prefix_folder + "/"+ project_name +"/"+pool_name+"/";
...
//				#SBATCH --exclude=node[029-033]
				...
				bw2.write("#!/bin/bash\n");
				bw.write("#SBATCH --job-name=50_2"+ tool_name + project_name+"\n");
				bw.write("#SBATCH --workdir="+ prefix_folder + "/"+ project_name +"\n");
				bw.write("#SBATCH --error="+project_name+"_2.error\n" );
				bw.write("#SBATCH --output="+project_name+"_2.out\n" );
				...
				for (int p=this.num_pool/2;p < this.num_pool;p ++) {
					String pool_name = project_name +"_p"+p;
					String pool_folder = prefix_folder + "/"+ project_name +"/"+pool_name+"/";
					...
					if(tool_name.equals("QuasiRecomb")) {
						...
						bw2.write("$python /home/jingni.he1/project/Viral_reconstruction/SLiM/programs/TenSQR.py $prefix\\.config\n");
						
					}else if(tool_name.equals("CliqueSNV")) {
						bw2.write("$java -Xmx30G -jar /home/jingni.he1/project/Viral_reconstruction/SLiM/programs/clique-snv.jar -m snv-illumina "
								//+ "-tf 0.01 "
								+"-in $inbam -log\n"
								);
					}else if(tool_name.equals("PredictHaplo")) {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		ScriptForTool_arc_new cs = new ScriptForTool_arc_new(prefix_folder,phx_folder_prefix,tool_name);
