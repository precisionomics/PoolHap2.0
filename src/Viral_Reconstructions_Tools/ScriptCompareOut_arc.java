...
public class ScriptCompareOut_arc {
...
//				#SBATCH --exclude=node[029-033]
				...
				bw.write("TransferToFasta = /home/jingni.he1/project/Viral_reconstruction/programs/TransferToFasta.jar\n");
				bw.write("TransferOutput = /home/jingni.he1/project/Viral_reconstruction/programs/Transfer_Output.jar\n");
				...
				for(int p=0;p<this.pools[i];p++) {
					...
					String pool_folder = prefix_folder + "/"+ project_name +"/"+pool_name+"/";
						if(tool_name.equals("QuasiRecomb")) {
							...
							br.close();
							bw.write("$java -jar /home/jingni.he1/project/Viral_reconstruction/programs/TransferToFasta.jar "+ pool_folder+pool_name+"_O2R.properties"+"\n");
							for (int f=0;f<num_file;f++) {
								bw.write("$clustalo -i "+ pool_folder+pool_name+"_"+f+".fasta -o "+ 
										pool_folder+pool_name+"_"+f+".fa\n");
							}
							bw.write("$java -Xmx20g -jar /home/jingni.he1/project/Viral_reconstruction/programs/Transfer_Output.jar "+ pool_folder+pool_name+"_O2R.properties"+"\n");
						}else {
							bw.write("$java -jar /home/jingni.he1/project/Viral_reconstruction/programs/TransferToFasta.jar "+ pool_folder+pool_name+"_O2R.properties"+"\n");
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		ScriptCompareOut_arc cs = new ScriptCompareOut_arc(prefix_folder,phx_folder_prefix,tool_name);
